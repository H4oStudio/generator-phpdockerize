    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/api/tags')) {
                // get_tag_fields
                if (0 === strpos($pathinfo, '/admin/api/tags/fields') && preg_match('#^/admin/api/tags/fields(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
            ...
            if (0 === strpos($pathinfo, '/admin/api')) {
                if (0 === strpos($pathinfo, '/admin/api/c')) {
                    ...
                    if (0 === strpos($pathinfo, '/admin/api/co')) {
                        if (0 === strpos($pathinfo, '/admin/api/contact')) {
                            if (0 === strpos($pathinfo, '/admin/api/contacts')) {
                                ...
                                if (preg_match('#^/admin/api/contacts/(?P<id>[^/\\.]++)(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                                    ...
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'patch_contact')), array (  '_controller' => 'Sulu\\Bundle\\ContactBundle\\Controller\\ContactController::patchAction',  '_format' => 'json',));
                                }
                                not_patch_contact:

                                // put_contact_title
                                if (preg_match('#^/admin/api/contacts/(?P<id>[^/]++)/title(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                                    if ('PUT' !== $canonicalMethod) {
                                        $allow[] = 'PUT';
                        ...
                        if (0 === strpos($pathinfo, '/admin/api/collection/fields') && preg_match('#^/admin/api/collection/fields(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                            if ('GET' !== $canonicalMethod) {
                                $allow[] = 'GET';
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/api/categories')) {
                        ...
                        if (preg_match('#^/admin/api/categories/(?P<parentId>[^/]++)/children(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                            if ('GET' !== $canonicalMethod) {
                                $allow[] = 'GET';
                        ...
                        if (preg_match('#^/admin/api/categories/(?P<id>[^/\\.]++)(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                            ...
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'post_category_trigger')), array (  '_controller' => 'Sulu\\Bundle\\CategoryBundle\\Controller\\CategoryController::postTriggerAction',  '_format' => 'json',));
                        }
                ...
                elseif (0 === strpos($pathinfo, '/admin/api/roles')) {
                    // get_role_fields
                    if (0 === strpos($pathinfo, '/admin/api/roles/fields') && preg_match('#^/admin/api/roles/fields(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                        if ('GET' !== $canonicalMethod) {
                            $allow[] = 'GET';
                    ...
                    // get_role_setting
                    if (preg_match('#^/admin/api/roles/(?P<roleId>[^/]++)/settings/(?P<key>[^/\\.]++)(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                        if ('GET' !== $canonicalMethod) {
                            $allow[] = 'GET';
                            goto not_get_role_setting;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'get_role_setting')), array (  '_controller' => 'Sulu\\Bundle\\SecurityBundle\\Controller\\RoleSettingController::getAction',  '_format' => 'json',));
                    }
                    ...
                    if (preg_match('#^/admin/api/roles/(?P<roleId>[^/]++)/settings/(?P<key>[^/\\.]++)(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'put_role_setting')), array (  '_controller' => 'Sulu\\Bundle\\SecurityBundle\\Controller\\RoleSettingController::putAction',  '_format' => 'json',));
                    }
                ...
                elseif (0 === strpos($pathinfo, '/admin/api/routes')) {
                    // get_routes
                    if (preg_match('#^/admin/api/routes(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                        if ('GET' !== $canonicalMethod) {
                            $allow[] = 'GET';
                            goto not_get_routes;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'get_routes')), array (  '_controller' => 'Sulu\\Bundle\\RouteBundle\\Controller\\RouteController::cgetAction',  '_format' => 'json',));
                    }
                    not_get_routes:

                    // delete_route
                    if (preg_match('#^/admin/api/routes/(?P<id>[^/\\.]++)(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                        if ('DELETE' !== $canonicalMethod) {
                            $allow[] = 'DELETE';
                            goto not_delete_route;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'delete_route')), array (  '_controller' => 'Sulu\\Bundle\\RouteBundle\\Controller\\RouteController::deleteAction',  '_format' => 'json',));
                    }
                    not_delete_route:
                ...
                if (0 === strpos($pathinfo, '/admin/api/node/resourcelocator') && preg_match('#^/admin/api/node/resourcelocator(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                    if ('DELETE' !== $canonicalMethod) {
                        $allow[] = 'DELETE';
                ...
                if (0 === strpos($pathinfo, '/admin/api/webspaces')) {
                    // get_webspaces
                    if (preg_match('#^/admin/api/webspaces(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                        if ('GET' !== $canonicalMethod) {
                            $allow[] = 'GET';
                            goto not_get_webspaces;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'get_webspaces')), array (  '_controller' => 'Sulu\\Bundle\\ContentBundle\\Controller\\WebspaceController::cgetAction',  '_format' => 'json',));
                    }
                    not_get_webspaces:

                    // get_webspace
                    if (preg_match('#^/admin/api/webspaces/(?P<webspaceKey>[^/\\.]++)(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                        if ('GET' !== $canonicalMethod) {
                            $allow[] = 'GET';
                ...
                // get_teasers
                if (0 === strpos($pathinfo, '/admin/api/teasers') && preg_match('#^/admin/api/teasers(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                    if ('GET' !== $canonicalMethod) {
                        $allow[] = 'GET';
                        goto not_get_teasers;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'get_teasers')), array (  '_controller' => 'Sulu\\Bundle\\ContentBundle\\Controller\\TeaserController::cgetAction',  '_format' => 'json',));
                }
                not_get_teasers:
                ...
                if (0 === strpos($pathinfo, '/admin/api/media')) {
                    ...
                    // get_media_formats
                    if (preg_match('#^/admin/api/media/(?P<id>[^/]++)/formats(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                        if ('GET' !== $canonicalMethod) {
                            $allow[] = 'GET';
                            goto not_get_media_formats;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'get_media_formats')), array (  '_controller' => 'Sulu\\Bundle\\MediaBundle\\Controller\\FormatController::cgetAction',  '_format' => 'json',));
                    }
                    not_get_media_formats:

                    // put_media_format
                    if (preg_match('#^/admin/api/media/(?P<id>[^/]++)/formats/(?P<key>[^/\\.]++)(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                        if ('PUT' !== $canonicalMethod) {
                            $allow[] = 'PUT';
                            goto not_put_media_format;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'put_media_format')), array (  '_controller' => 'Sulu\\Bundle\\MediaBundle\\Controller\\FormatController::putAction',  '_format' => 'json',));
                    }
                ...
                elseif (0 === strpos($pathinfo, '/admin/api/snippet')) {
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/api/snippet-areas')) {
                        // get_snippet-areas
                        if (preg_match('#^/admin/api/snippet\\-areas(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                            if ('GET' !== $canonicalMethod) {
                                $allow[] = 'GET';
                                goto not_get_snippetareas;
                            }

                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'get_snippet-areas')), array (  '_controller' => 'Sulu\\Bundle\\SnippetBundle\\Controller\\SnippetAreaController::cgetAction',  '_format' => 'json',));
                        }
                        not_get_snippetareas:

                        // put_snippet-area
                        if (preg_match('#^/admin/api/snippet\\-areas/(?P<key>[^/\\.]++)(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                            if ('PUT' !== $canonicalMethod) {
                                $allow[] = 'PUT';
                                goto not_put_snippetarea;
                            }

                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'put_snippet-area')), array (  '_controller' => 'Sulu\\Bundle\\SnippetBundle\\Controller\\SnippetAreaController::putAction',  '_format' => 'json',));
                        }
                        not_put_snippetarea:
                        ...
                        if (preg_match('#^/admin/api/snippet\\-areas/(?P<key>[^/\\.]++)(?:\\.(?P<_format>json|csv|html))?$#s', $pathinfo, $matches)) {
                            ...
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'delete_snippet-area')), array (  '_controller' => 'Sulu\\Bundle\\SnippetBundle\\Controller\\SnippetAreaController::deleteAction',  '_format' => 'json',));
                        }
            ...
            // sulu_media.redirect
            if (0 === strpos($pathinfo, '/admin/media/redirect/media') && preg_match('#^/admin/media/redirect/media/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
